...
\newtheorem{minordefinition}[theorem]{Définition}
\newtheorem{proposition}[theorem]{Proposition}
\newtheorem{property}[theorem]{Propiété}
\newtheorem{importantproperty}[theorem]{Propriété}
\newtheorem{importanttheorem}[theorem]{Théorème}
