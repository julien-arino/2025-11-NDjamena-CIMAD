...
\vfill
\begin{center}
\includegraphics[width=\textwidth]{FIGS/cours-01-KMK_SI_plane-1.pdf}
\end{center}
\end{frame}
...
\hlkwd{plot}\hldef{(sol_KMK[,} \hlsng{"time"}\hldef{], sol_KMK[,} \hlsng{"I"}\hldef{],}
     ...
     \hlkwc{xlab} \hldef{=} \hlsng{"Temps (jours)"}\hldef{,} \hlkwc{ylab} \hldef{=} \hlsng{"Prévalence"}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
\begin{center}
\includegraphics[width=0.8\textwidth]{FIGS/cours-01-KMK_R0eq1dot5-1.pdf}
\end{center}
\end{frame}
...
\hldef{S_inf} \hlkwb{=} \hlkwd{uniroot}\hldef{(}\hlkwc{f} \hldef{=} \hlkwa{function}\hldef{(}\hlkwc{x}\hldef{)} \hlkwd{final_size_eq}\hldef{(}\hlkwc{S_inf} \hldef{= x,}
                                              ...
                                              \hlkwc{R_0} \hldef{= R_0),}
                \hlkwc{interval} \hldef{=} \hlkwd{c}\hldef{(}\hlnum{0.05}\hldef{, S0))}
\hlkwd{plot}\hldef{(S, fs,} \hlkwc{type} \hldef{=} \hlsng{"l"}\hldef{,} \hlkwc{ylab} \hldef{=} \hlsng{"Valeur de l'équation (10)"}\hldef{)}
...
\begin{frame}{$\R_0=0.8$}
\begin{center}
  \includegraphics[width=\textwidth]{FIGS/cours-01-KMK_final_size_0p8-1.pdf}
\end{center}
\end{frame}
...
\begin{frame}{$\R_0=2.4$}
  \begin{center}
    \includegraphics[width=\textwidth]{FIGS/cours-01-KMK_final_size_2p5-1.pdf}
  \end{center}
\end{frame}
...
\begin{frame}{Taux d'attaque (en \%)}
  \begin{center}
    \includegraphics[width=0.9\textwidth]{FIGS/cours-01-KMK_attack_rate-1.pdf}
  \end{center}
\end{frame}
...
\begin{frame}{}
  \begin{center}
    \includegraphics[width=\textwidth]{FIGS/cours-01-SIRS_one_sim_prevalence-1.pdf}
  \end{center}
\end{frame}
...
\begin{frame}{}
  \begin{center}
    \includegraphics[width=\textwidth]{FIGS/cours-01-SIRS_3_sims_prevalence-1.pdf}
  \end{center}
\end{frame}
...
\begin{frame}
  \begin{center}
    \includegraphics[width=\textwidth]{FIGS/cours-01-SIRS_bifurcation_R0-1.pdf}
  \end{center}
\end{frame}
