...
\vfill
\begin{center}
\includegraphics[width=0.9\textwidth]{\Sexpr{fig_chunk('KMK_SI_plane', 'pdf')}}
\end{center}
\end{frame}
...
@
\begin{center}
\includegraphics[width=0.8\textwidth]{\Sexpr{fig_chunk('KMK_R0eq1dot5', 'pdf')}}
\end{center}
\end{frame}
...
\begin{frame}{$\R_0=0.8$}
\begin{center}
  \includegraphics[width=\textwidth]{\Sexpr{fig_chunk('KMK_final_size_0p8', 'pdf')}}
\end{center}
\end{frame}
...
\begin{frame}{$\R_0=2.4$}
  \begin{center}
    \includegraphics[width=\textwidth]{\Sexpr{fig_chunk('KMK_final_size_2p5', 'pdf')}}
  \end{center}
\end{frame}
...
\begin{frame}{Taux d'attaque (en \%)}
  \begin{center}
    \includegraphics[width=0.9\textwidth]{\Sexpr{fig_chunk('KMK_attack_rate', 'pdf')}}
  \end{center}
\end{frame}
